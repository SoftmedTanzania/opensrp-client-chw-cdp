...
public class DBConstants {
    ...
    public final class KEY {
        ...
        public static final String DATE_CHW_CDP_TEST = "date_chw_cdp_test";
        public static final String FEVER_CDP_CHW = "fever_cdp_chw";
        public static final String FEVER_DURATION = "fever_duration";
        public static final String CDP_RESULTS = "cdp_results";
        public static final String DATE_HF_CDP_TEST = "date_hf_cdp_test";
        public static final String CDP_TEST_DATE = "cdp_test_date";
        public static final String CDP_TREAT = "cdp_treat";
        ...
        public static final String CDP_EDU_CHW = "cdp_edu_chw";
        ...
        public static final String PHONE_NUMBER_CDP = "phoneNumberCDP";
        public static final String GEST_AGE = "gest_age";
        public static final String DELIVERY_DATE = "delivery_date";
        public static final String CDP_FOLLOW_UP_DATE = "date_chw_mfollowup";
